...
def home():
    ...
    for row in query:
        ...
        if small_image:
            html = get('https://www.google.com/search?q={}+movie+{}&tbm=isch'.format(row[0], row[3])).text
            ...
            html = get('https://www.google.com/search?q={}+movie+{}&tbm=isch'.format(row[0], row[3]), headers={
